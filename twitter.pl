...
sub moment_ago {
  ...
  if ($delta > 2628000) {
    ...
    $ago = $mon <= 1  ? 'about a month ago.'
         : $mon <= 2  ? 'a couple of months ago.'
         : $mon <= 3  ? 'a couple of months ago.'
         : $mon <= 4  ? 'a couple of months ago.'
         : $mon <= 5  ? 'about half a year ago.'
         : $mon <= 6  ? 'about half a year ago.'
         : $mon <= 7  ? 'half a year ago.'
         : $mon <= 8  ? 'less than a year ago.'
         : $mon <= 9  ? 'less than a year ago.'
         : $mon <= 10 ? 'less than a year ago.'
         : $mon <= 11 ? 'less than a year ago.'
         : $mon <= 12 ? 'almost a year ago.'
         : $mon <= 13 ? 'almost a year ago.'
         : $mon <= 18 ? 'more than a year ago.'
         : $mon <= 23 ? 'almost 2 years ago.'
         : $mon <= 24 ? 'almost 2 years ago.'
         : $mon <= 25 ? 'almost 2 years ago.'
         : $mon <= 26 ? 'almost 2 years ago.'
         : $mon <= 27 ? 'almost 2 years ago.'
         : $mon <= 35 ? 'almost 3 years ago.'
         : $mon <= 36 ? 'almost 3 years ago.'
         : $mon <= 37 ? 'almost 3 years ago.'
         : $mon <= 38 ? 'almost 3 years ago.'
         : $mon <= 39 ? 'almost 3 years ago.'
         : $mon <= 47 ? 'almost 4 years ago.'
         : $mon <= 48 ? 'almost 4 years ago.'
         : $mon <= 49 ? 'almost 4 years ago.'
         : $mon <= 50 ? 'almost 4 years ago.'
         : $mon <= 51 ? 'almost 4 years ago.'
         : $mon <= 52 ? 'almost 4 years ago.'
