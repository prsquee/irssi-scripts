...
signal_register( { 'showme the usd'   => [ 'iobject','string','string','string' ]}); #server,chan,coin,howmuch
...
signal_register( { 'kraken released'  => [ 'iobject','string','string','string' ]}); #server,chan,coin,howmuch
